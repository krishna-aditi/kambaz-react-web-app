...
export default function TOC() {
    ...
    return (
      ...
      <Nav variant="pills">
        ...
        <Nav.Item>
          <Nav.Link href="#/Labs/Lab4" id="wd-a4" active={pathname.includes("Lab4")}>Lab 4</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link href="#/Labs/Lab5" id="wd-a5" active={pathname.includes("Lab5")}>Lab 5</Nav.Link>
        </Nav.Item>
        <Nav.Item>
