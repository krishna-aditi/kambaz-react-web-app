        ...
        <div id="wd-css-position-relative">
            ...
            <div className="wd-bg-color-gray">
                <div className="wd-bg-color-yellow 
                    ...
                    <div className="wd-pos-relative-nudge-down-right"> {/*Setting a relative position just for the "Portrait" element ONLY, not for the whole yellow box*/}
                        Portrait
                    </div>
                </div>
                <div className="wd-pos-relative-nudge-up-right 
                    wd-bg-color-blue
                    wd-fg-color-white 
                    wd-dimension-landscape"> {/*Setting the relative position for the whole purple box, NOT just the "Landscape" element - i.e. the "Landscape" element is nudged up and to the right using the nudge-up-right class*/}
                    Landscape
                </div>
